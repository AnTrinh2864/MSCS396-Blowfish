...
public class Blowfish {
    ...
    private String encrypt(String plainText)
    {
        ...
        System.out.println("This blowfish encryption took: "
                + (endTime - startTime) * 1000 / 1e9 + " ms");

        return left + right;
    }
    Blowfish(String plainText)
    {
        for (int i = 0; i < 32; i++)
            modVal = modVal << 1;
        ...
        keyGenerate(key);
        //Probably have to put these in loop and deal with the stuff with plaintext block of 8
    ...
    private String decrypt(String plainText)
    {
        ...
        long endTime = System.nanoTime();
        System.out.println("This blowfish decryption took: "
                + (endTime - startTime) * 1000 / 1e9 + " ms");
